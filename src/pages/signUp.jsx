        ...
        <section className="md:flex md:space-x-6 md:space-y-0 space-y-8 px-2">
                ...
                <form className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="h-10 md:h-12 flex rounded-md px-2 items-center bg-[#f5f5f5] w-full mx-auto " 
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            className="h-10 md:h-12 flex px-2 items-center  rounded-md bg-[#f5f5f5] w-full mx-auto " 
                        />
                    </div>
                    ...
                    <h2>
                        Already a user? 
                        <span>
                            <Link to="/camps/signIn" className="mx-2 text-sky-600 font-semibold underline" >
                                Sign in
                            </Link>
                        </span>
                    </h2>
            ...
            <article className="bg-[#f5f5f5] flex justify-center md:max-w-[50%] md:p-28 py-12 px-8 flex-col items-start">
                ...
                <div className="flex space-x-4 items-center">
                    ...
                    <div className="">
                        <h1 className="font-bold text-xs">May Andrews</h1>
